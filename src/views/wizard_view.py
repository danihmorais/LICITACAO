...
from src.views.steps.etapa_1_view import Etapa1View
from src.views.steps.etapa_2_view import Etapa2View
from src.views.steps.etapa_3_view import Etapa3View
from src.views.steps.etapa_4_view import Etapa4View
from src.views.steps.etapa_5_view import Etapa5View
from src.views.missing_placeholders_view import MissingPlaceholdersDialog
