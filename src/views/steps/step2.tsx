...
export default function Step2({ dados, atualizarDados }: any) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <div>
        <h2 style={{ fontSize: "16px", margin: "0 0 8px 0", color: "#111827" }}>Condições de Execução e Prazos</h2>
      ...
      <div>
        <textarea 
          ...
          style={{ width: "100%", padding: "16px", borderRadius: "12px", border: "1px solid #D1D5DB", minHeight: "220px", fontSize: "14px", resize: "vertical", boxSizing: "border-box" }}
        />
      </div>
    </div>
  );
