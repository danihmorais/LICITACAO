...
export default function Step3({ dados, atualizarDados }: any) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <div>
        <h2 style={{ fontSize: "16px", margin: "0 0 8px 0", color: "#111827" }}>Secretarias Demandantes</h2>
      ...
      <div style={{ background: "#F9FAFB", border: "1px solid #E5E7EB", borderRadius: "14px", padding: "16px", maxHeight: "230px", overflowY: "auto", display: "flex", flexDirection: "column", gap: "12px" }}>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {dados.secretarias.length === 0 && (
            <p style={{ color: "#6B7280", fontSize: "13px" }}>Nenhuma secretaria selecionada.</p>
          )}
            ...
            <div key={sec} style={{ background: "white", border: "1px solid #D1D5DB", borderRadius: "12px", padding: "16px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
                ...
                <button 
                  ...
                  style={{ padding: "8px 16px", background: "#2563EB", color: "white", border: "none", borderRadius: "8px", fontWeight: "bold", fontSize: "12px", cursor: "pointer" }}
                >
                  + Adicionar
                </button>
              </div>
